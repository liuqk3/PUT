...
parser.add_argument('--path1', type=str, default='data/fid_statics/ffhq_train_fid_statcs_256_center.npz',
...
parser.add_argument('--path2', type=str, default='RESULT/taming_facehq_learnRandomCardinal16Softmax_orthoEquipartionLoss_normEmb_normFeat_KlLossAll_transformerTemp50_bs8g4_val_e99/cond1_cont0_fr0_image_k16_t1', #TODO '',
                    help='Paths to the generated images or txt file contain the relative path of images')
...
parser.add_argument('--max_count2', type=int, default=10000, #TODO None,
...
parser.add_argument('--count2', type=int, default=5000, #TODO None,
                    help='the count of images to be sampled in path2 to be coumputed') 
parser.add_argument('--im_size1', type=str, default='256', #TODONone,
                    help='count of images in path1 to be coumputed') 
parser.add_argument('--im_size2', type=str, default='256',#TODONone,
                    help='count of images in path1 to be coumputed')                     
...
def calculate_fid_given_paths(path1, path_prefix1, 
                              path2, path_prefix2, 
                              batch_size,  device, 
                              dims, num_workers=8, 
    ...
    m1, s1 = compute_statistics_of_path(path1, path_prefix1, model, batch_size,
                                        dims, device, num_workers, max_count1, count1, im_size1)
    m2, s2 = compute_statistics_of_path(path2, path_prefix2, model, batch_size,
...
def main():
    ...
    for l in range(args.loops):
        fid_value = calculate_fid_given_paths(path1=args.path1,
