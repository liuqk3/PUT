...
def get_model(args):
    model_path_dict = {
        # default models for cvpr2022
        'cvpr2022_ffhq': 'OUTPUT/cvpr2022_transformer_ffhq/checkpoint/last.pth',
        'cvpr2022_naturalscene': 'OUTPUT/cvpr2022_transformer_naturalscene/checkpoint/000199e_495399iter.pth',
        'cvpr2022_imagenet': 'OUTPUT/cvpr2022_transformer_imagenet/checkpoint/000044e_600524iter.pth',
        
        # default models for tpami2024
        'tpami2024_imagenet_256': 'OUTPUT/tpami2024_vit_base_imagenet_res256/checkpoint/000299e_1000799iter.pth',
        'tpami2024_imagenet_512': 'OUTPUT/tpami2024_vit_base_imagenet_res512/checkpoint/last.pth',
        'tpami2024_naturalscene_256': 'OUTPUT/tpami2024_vit_base_naturalscene_res256/checkpoint/000599e_742800iter.pth',
        'tpami2024_naturalscene_512': 'OUTPUT/tpami2024_vit_base_naturalscene_res512/checkpoint/000599e_742800iter.pth',
        'tpami2024_ffhq_256': 'OUTPUT/tpami2024_vit_base_ffhq_res256/checkpoint/last.pth',
        'tpami2024_ffhq_512': 'OUTPUT/tpami2024_vit_base_ffhq_res512/checkpoint/last.pth',
    }
...
def prepare_im_and_mask(args, im, mask):
...
def inpaint(args, model, data):
    ...
    while count < args.num_samples:
        ...
        inputs = {
            'batch': {k:v.clone() for k, v in data.items()}, # data,
...
def get_args():
    ...
    parser.add_argument('--name', type=str, default='tpami2024_ffhq_256',
    ...
    parser.add_argument('--save_dir', type=str, default='RESULT_UI', 
...
if __name__ == '__main__':
    ...
    if args.ui:
        ...
        from image_synthesis.ui.image_inpaint.demo import Ex
