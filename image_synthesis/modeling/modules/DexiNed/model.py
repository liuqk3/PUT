...
from image_synthesis.modeling.utils.misc import image_normalization
...
class DexiNed(nn.Module):
    ...
    def __init__(self):
        ...
        self.bgr_mean = torch.tensor([103.939, 116.779, 123.68]).reshape(1,3,1,1)
    ...
    def forward(self, x):
        ...
        fused = torch.sigmoid(block_cat)
        fused = image_normalization(fused).to(torch.uint8)
        fused = torch.bitwise_not(fused)
