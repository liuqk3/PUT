...
python scripts/metrics/cal_fid.py --path1 ${gt_dir} --path2 ${result_dir} --device ${device} --net inception --share_same_files
# python scripts/metrics/cal_fid.py --path1 ${gt_dir} --path2 ${result_dir} --device ${device} --net clip --share_same_files
